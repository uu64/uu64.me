...
date: "2020-05-13"
description: "書籍「サーバーレスシングルページアプリケーション」を読みつつ、AWS CloudFormation を用いたサーバーレス環境構築や監視について勉強しました。"
cover: "book.jpg"
---
...
- https://aws.typepad.com/sajp/2016/04/node-js-4-3-2-runtime-now-available-on-lambda.htmlA